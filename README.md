...
- one of the main features of Node.js is being able to install package dependencies, it's makes it libraries and tools easily accessible to the developer. Node is fast and scalable which is what every team wants. One of the core features of express is it allows us to use routes, that way we can organize our code in any way we want. It also allows us to write handlers for our requests.

1. Understand and explain the use of Middleware.

- middleware is extremely helpful when it comes to writing request because we can keep our code as simple as possible while allowing the middleware to find the problem and execute accordingly.

1. The basic principles of the REST architectural style.

- Client-server, layered system, code on demand, cacheable and and stateless. REST is resource state while the client is application state. Rest talks to the client via CRUD methods, ex get,post, update,delete.

1. Understand and explain the use of Express Routers.

- express routers makes it simple to separate our server and routers, it also allows us to keep our code dry and simple.

1. Describe tooling used to manually test the correctness of an API.

- There are many ways to test an API , one of my favorites tools are Postman and Httpie, It makes it easy to debug if there is a mistake. Another great tool is the node debugger, setting break points to test where the request is going wrong.
